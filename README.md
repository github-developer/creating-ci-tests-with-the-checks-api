This is an example GitHub App that creates a CI server that runs CI tests using the GitHub [Checks API](https://developer.github.com/v3/checks/). You can follow the "[Creating CI tests with the Checks API](https://developer.github.com/apps/quickstart-guide/creating-ci-tests-with-the-checks-api)" quickstart guide on developer.github.com to learn how to build the app code in `server.rb`.
...
To learn how to set up a template GitHub App, follow the "[Setting up your development environment](https://developer.github.com/apps/quickstart-guide/setting-up-your-development-environment)" quickstart guide on developer.github.com.
